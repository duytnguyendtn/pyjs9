...
class JS9:
    ...
    def __init__(self, host='http://localhost', port=2718, id='JS9', socketio_path=None, multi=False, pageid=None, maxtries=5, delay=1, debug=False):  # pylint: disable=redefined-builtin, too-many-arguments, line-too-long
        """
        :param host: host and endpoint of JS9 Helper (def: 'http://localhost')
        :param port: port of the JS9 Helper service, appended to the host (def: 2718)
        ...
        logging.warn(f"### Trying Transport mode: {js9Globals['transport']}")
        if js9Globals['transport'] == 'socketio':
            try:
                ...
                logging.warn(f"socketio connect failed: {e}, using html")
                js9Globals['transport'] = 'html'
        logging.warn(f"### Using Transport mode: {js9Globals['transport']}")
        self._block_cb = None
